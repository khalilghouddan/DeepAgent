      ...
      <section className="card doc-card">
        ...
        <section className="doc-section">
          ...
          <p>
            ...
            answer. Research runs and discovered sources are saved to the
            database so the work can be reviewed later.
          </p>
...
BASE_URL=http://102.54.244.89:8088/ollama-v2/api/v1
API_KEY=`}</pre>
            </article>
...
OPENAI_BASE_URL=`}</pre>
        ...
        <section className="doc-section">
          ...
          <ol className="doc-steps">
            ...
            <li>Choose search language, log level, and the date used in prompts.</li>
